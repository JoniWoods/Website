...
export function Services() {
  return (
    <section id="services" className="px-4 sm:px-6 md:px-8 lg:container space-y-6 sm:space-y-8 md:space-y-10 py-6 sm:py-8 md:py-10 lg:py-12 xl:py-16 dark:bg-transparent bg-muted/50">
